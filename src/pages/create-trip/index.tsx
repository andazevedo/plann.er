...
export function CreateTripPage() {
  ...
  const [isGuestsInputOpen, setIsGestsInputOpen] = useState(false);
  const [isGuestsModalOpen, setIsGestsModalOpen] = useState(false);
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="space-y-4">
          <DestinationAndDateStep
            ...
            eventStartAndDates={eventStartAndEndDates}
            setEventStartAndDates={setEventStartAndEndDates}
          />
